...
import { DraggableItemMobile } from "./DraggableItem";
...
export const DroppableColumnMobile = ({
  id,
  indicatorColor,
  column,
  index,
  ...
  return (
    <div className="flex flex-col space-y-10  min-w-[200px] columsexxx" style={{ height: 'fit-content' }} key={index}>
          ...
          return (
            <div {...provided.droppableProps} ref={provided.innerRef}>
              {column.items.map((item: any, index: number) => {
                return <DraggableItemMobile item={item} index={index} key={index} />;
              })}
