...
import { DraggableItemTable } from "./DraggableItem";
...
export const DroppableColumnTable = ({
  id,
  indicatorColor,
  column,
  index,
  ...
  return (
    <div className="  space-y-10  w-full columsexxx" style={{ height: 'fit-content' }} key={index}>
          ...
          return (
            <div {...provided.droppableProps} ref={provided.innerRef}>
              {column.items.map((item: any, index: number) => {
                return <DraggableItemTable item={item} index={index} key={index} />;
              })}
